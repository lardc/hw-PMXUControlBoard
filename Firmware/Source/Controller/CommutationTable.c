...
{
	{LCSU_PLUS_TO_PWR_H,  REGISTER_1, BIT0, REGISTER_1, BIT0, false},
	{LCSU_PLUS_TO_PWR_C,  REGISTER_1, BIT0, REGISTER_1, BIT0, false},
	{LCSU_PLUS_TO_PWR_L,  REGISTER_1, BIT0, REGISTER_1, BIT0, false},
	{LCSU_MINUS_TO_PWR_H, REGISTER_1, BIT0, REGISTER_1, BIT0, false},
	{LCSU_MINUS_TO_PWR_C, REGISTER_1, BIT0, REGISTER_1, BIT0, false},
	{LCSU_MINUS_TO_PWR_L, REGISTER_1, BIT0, REGISTER_1, BIT0, false}
};
