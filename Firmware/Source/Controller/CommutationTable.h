...
static const Int8U CT_UCESAT_POS1_GROUP_GREEN[] = {LCSU_POS_TO_PWR_C, LCSU_NEG_TO_PWR_L};
static const Int8U CT_UCESAT_POS2_GROUP_BLUE[] = {LCSU_POS_TO_PWR_H, LCSU_NEG_TO_PWR_C};
static const Int8U CT_UCESAT_POS2_GROUP_ORANGE[] = {LCSU_POS_TO_PWR_H, LCSU_NEG_TO_PWR_L};

// UFW_CHOPPER_DIODE commutations
static const Int8U CT_UFW_POS1_GROUP_GREEN[] = {LCSU_POS_TO_PWR_L, LCSU_NEG_TO_PWR_C};
static const Int8U CT_UFW_POS1_GROUP_BLUE[] = {LCSU_POS_TO_PWR_C, LCSU_NEG_TO_PWR_H};
static const Int8U CT_UFW_POS2_GROUP_BLUE[] = {LCSU_POS_TO_PWR_C, LCSU_NEG_TO_PWR_H};
static const Int8U CT_UFW_POS2_GROUP_ORANGE[] = {LCSU_POS_TO_PWR_L, LCSU_NEG_TO_PWR_H};
static const Int8U CT_UFW_POS2_GROUP_PURPLE[] = {LCSU_POS_TO_PWR_H, LCSU_NEG_TO_PWR_C};

// ICES_OR_IRMM commutations
static const Int8U CT_ICES_POS1_GROUP_GREEN[] = {LCTU_POS_TO_PWR_C, LCTU_NEG_TO_PWR_L};
static const Int8U CT_ICES_POS1_GROUP_BLUE[] = {LCTU_POS_TO_PWR_H, LCTU_NEG_TO_PWR_C};
static const Int8U CT_ICES_POS2_GROUP_BLUE[] = {LCTU_POS_TO_PWR_H, LCTU_NEG_TO_PWR_C};
static const Int8U CT_ICES_POS2_GROUP_ORANGE[] = {LCTU_POS_TO_PWR_H, LCTU_NEG_TO_PWR_L};
static const Int8U CT_ICES_POS2_GROUP_PURPLE[] = {LCTU_POS_TO_PWR_C, LCTU_NEG_TO_PWR_H};
